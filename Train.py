...
# file.close()
TrainDatapath = "/home/mvidyasa/Documents/Relation_Classifier/resources/traindata_10_02"
...
save_path = None
ae_model_path = "AE_Models/Model_14_March_Sample/model.ckpt"
min_loss = 3
loss = None
...
for i in range(30000):
    print "Epoch : "+str(i)
    _, loss = sess.run([optimizer, auto_encoder.loss], feed_dict= {auto_encoder.input_embeddings: train_data})
    print "Loss : "+str(loss)
    # if loss >100000:
    #     sess.run(tf.global_variables_initializer())
    #     print "Reinitialized"
